...
// Default Select Usage
const defaultSelectUsage = `'use client'
...
// Multi Select Usage  
const multiSelectUsage = `'use client'
...
// Searchable Select Usage
const searchableSelectUsage = `'use client'
...
// Export Tab Arrays
export const selectComponentTabs = [
  { label: "Component", code: selectComponentCode }
]

export const defaultSelectTabs = [
  { label: "Component", code: defaultSelectUsage }
]

export const multiSelectTabs = [
  { label: "Component", code: multiSelectUsage }
]

export const searchableSelectTabs = [
  { label: "Component", code: searchableSelectUsage }
] 