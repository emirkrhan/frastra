            ...
            <AnimatePresence>
                {isMenuOpen && (
                    <motion.div
                        ...
                        className="absolute top-full right-0 mt-2 w-48 bg-neutral-900/50 border border-white/10 backdrop-blur-sm rounded-xl shadow-lg p-1 z-50"
                    >
                        <div className="px-2 py-1.5 text-xs text-neutral-400">Theme</div>
                         <ThemeMenuItem icon={Sun} label="Light" onClick={() => setTheme('light')} />
                         <ThemeMenuItem icon={Moon} label="Dark" onClick={() => setTheme('dark')} />
                         <ThemeMenuItem icon={Monitor} label="System" onClick={() => setTheme('system')} />
                    </motion.div>
                )}
            </AnimatePresence>
          </div>
