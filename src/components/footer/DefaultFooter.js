...
export default function DefaultFooter() {
  return (
    <footer
      className="w-full bg-tertiary border border-border rounded-xl"
      ...
      <div className="mx-auto max-w-7xl px-6 pb-8 pt-16 sm:pt-24 lg:px-8 lg:pt-32">
        <div className="xl:grid xl:grid-cols-3 xl:gap-8">
          <div className="space-y-8">
            ...
            <p className="text-descriptive-size leading-6 text-descriptive">
                  ...
                  <ul role="list" className="mt-6 space-y-4">
                    {section.links.map((item) => (
                      <li key={item.name}>
                        <a
                          href={item.href}
                          className="text-descriptive-size leading-6 text-descriptive hover:text-white"
                        >
                          {item.name}
                        </a>
                      </li>
        ...
        <div className="mt-16 border-t border-border pt-8 sm:mt-20 lg:mt-24 lg:flex lg:items-center lg:justify-between">
          <div className="flex space-x-6 lg:order-2">
            {socialLinks.map((item) => (
              <a
                key={item.name}
                href={item.href}
                className="text-descriptive hover:text-descriptive"
              >
          ...
          <p className="mt-8 text-tips-size leading-5 text-tips lg:order-1 lg:mt-0">
